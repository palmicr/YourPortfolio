...
use php\Upload; # declaration, so you can refer to the class as Upload rather than using the fully qualified name
					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								<li><a href="php/logout.php" id="logout-link" class="skel-layers-ignoreHref"><span class="icon fa-sign-out">Sign Out</span></a></li>
